  ...
  return (
    <div className="space-y-12">
      <section className="space-y-3">
        <h1 className="text-2xl font-bold text-zinc-100">Live playground</h1>
      ...
      {baseline && (
        <section className="space-y-3">
          <h2 className="text-xl font-semibold text-zinc-100">Before / after</h2>
          <p className="max-w-2xl text-sm text-zinc-400">
      ...
      <section className="space-y-3">
        <h2 className="text-xl font-semibold text-zinc-100">The corpus</h2>
        <DocsGallery />
      </section>
    </div>
  );
